...
data class RoomStateModal(
    ...
    @SerializedName("wantRematch") var wantRematch: Array<Boolean?> = arrayOf(null, null),
    ...
    @SerializedName("board") var board: Array<Array<String>> = arrayOf(
        arrayOf("", "", ""),
        arrayOf("", "", ""),
        arrayOf("", "", "")
    ),
    @SerializedName("rowHash") var rowHash: Array<Array<Int>> = arrayOf(
        arrayOf(0, 0),
        arrayOf(0, 0),
        arrayOf(0, 0)
    ),
    @SerializedName("colHash") var colHash: Array<Array<Int>> = arrayOf(
        arrayOf(0, 0),
        arrayOf(0, 0),
        arrayOf(0, 0)
    )
